...
public class BlueLongShot extends OpMode {
    ...
    private void buildPaths() {
        // Path from blueLongStart to blueLongScore (initial positioning)
        ...
        switch (pathState) {
            ...
            case 4:
                ...
                if (!isCollecting) {
                    ...
                    // Build path back to score from current position
